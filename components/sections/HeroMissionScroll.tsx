...
/** More pinned scroll = smoother motion per pixel. */
...
export function HeroMissionScroll() {
  ...
  /** Bottom card — subtle depth only, no hard fades. */
  ...
  /**
   * Full-screen top sheet: many stops so motion eases in/out of rest
   * (same curve reversed when scrolling up).
   */
  ...
  return (
    ...
    >
      <div className="sticky top-0 h-svh min-h-svh w-full overflow-hidden bg-[var(--page-canvas)]">
        <motion.div
